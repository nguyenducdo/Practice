...
/*
$example = function () {
    var_dump($message); // Undefined variable '$message'
};
$example();
//*/
...
{
    if(!empty($myInstance->value)) echo "in broken: {$myInstance->value}\n";
};

$working = function() use (&$myInstance)
{
    if(!empty($myInstance->value)) echo "in working: {$myInstance->value}\n";
};
